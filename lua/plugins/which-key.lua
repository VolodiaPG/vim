  ...
  config = function()
    ...
    which_key.register({
      ["<leader>"] = {
        ...
        h = {
          name = "Harpoon",
          s = { function() require("harpoon"):list():append() end, "Add file" },
          d = { function() require("harpoon").ui:toggle_quick_menu(require("harpoon"):list()) end, "Toggle menu" },
          p = { function() require("harpoon"):list():prev() end, "Previous file" },
          ...
          ["6"] = { function() require("harpoon"):list():select(6) end, "File 6" },
          ["7"] = { function() require("harpoon"):list():select(7) end, "File 7" },
          ["8"] = { function() require("harpoon"):list():select(8) end, "File 8" },
          ["9"] = { function() require("harpoon"):list():select(9) end, "File 9" },
        },
        l = {
          name = "LSP",
        ...
        d = {
          ...
          l = { function() vim.diagnostic.setloclist() end, "Set loclist" },
        },
      },
    })
  end,
